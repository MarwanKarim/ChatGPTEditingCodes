            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="کاری یاریدەدەری سەرپەرشتیار"></asp:Label>
  ...
  AllowAutomaticUpdates="True"  CssClass="GV_style" AllowPaging="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataKeyNames="weeklyJobEntry_ID" AllowAutomaticUpdates="true"
                ...
                <Columns>
                    ...
                    <%--======================================================================--%>
                            <telerik:GridTemplateColumn HeaderText="کارەکان" DefaultInsertValue="jobName" 
                       ...
                       <telerik:GridTemplateColumn HeaderText="ژمارە" DefaultInsertValue="numberOfJobs" HeaderStyle-Width="220px" 
