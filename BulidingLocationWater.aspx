<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="BulidingLocationWater" Codebehind="BulidingLocationWater.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="ئاو خواردنەوە	"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_Bulid_Loc_Water_Name" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>
    

 <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_Bulid_Loc_Water_Name" runat="server" ID="RequiredFieldValidator2" 
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_Bulid_Loc_Water_Note" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>
    

<%-- <asp:RequiredFieldValidator ControlToValidate="txt_Bulid_Loc_Water_Note" runat="server" ID="RequiredFieldValidator3" 
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />--%>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_Bulid_Loc_Water_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
   <asp:Label ID="lbl_result_msg" runat="server" Text="Date Added succesfully ." Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Bulid_Loc_Water_ID"
                                        DataSourceID="sds_BulidingLocationWater" Width="100%" GridLines="None" PageSize="30">
    ...
    <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="Bulid_Loc_Water_ID" InsertVisible="False"   Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Bulid_Loc_Water_ID_GV" runat="server" Text='<%# Eval("Bulid_Loc_Water_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_Name" runat="server" Text='<%# Eval("Bulid_Loc_Water_Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_Details" runat="server" Text='<%# Eval("Bulid_Loc_Water_Note") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" InitialValue="0" />--%>
    ...
    <asp:SqlDataSource ID="sds_BulidingLocationWater" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        DeleteCommand="BulidingLocationWater_Delete"
        InsertCommand="BulidingLocationWater_Insert"
        SelectCommand="BulidingLocationWater_Select" SelectCommandType="StoredProcedure"
        UpdateCommand="BulidingLocationWater_Update" DeleteCommandType="StoredProcedure"
        InsertCommandType="StoredProcedure" UpdateCommandType="StoredProcedure"
        
     OnDeleted="sds_BulidingLocationWater_Deleted"

    OnUpdated="sds_BulidingLocationWater_Updated"
    OnInserted="sds_BulidingLocationWater_Inserted"
        >
        <DeleteParameters>
      <asp:Parameter ConvertEmptyStringToNull="True" DefaultValue="000" Direction="InputOutput" Name="ErrorMessage" Type="String" />

    <asp:ControlParameter ControlID="lbl_Bulid_Loc_Water_ID" Name="Bulid_Loc_Water_ID" Type="Int32" />
      ...
      <asp:ControlParameter ControlID="ddl_EducationalBoard"    Name="EducationalBoard_Fkey" Type="Int32" />
            <asp:ControlParameter ControlID="txt_Bulid_Loc_Water_Name"   Name="Bulid_Loc_Water_Name" Type="String" />
          <asp:ControlParameter ControlID="txt_Bulid_Loc_Water_Note"   Name="Bulid_Loc_Water_Note" Type="String" />
            <asp:ControlParameter ControlID="lbl_UserID"    Name="user_Insert" Type="Int32" DefaultValue="0" />
    ...
    <asp:ControlParameter ControlID="lbl_Bulid_Loc_Water_ID" Name="Bulid_Loc_Water_ID" Type="Int32" />
        ...
        <asp:SqlDataSource ID="sds_BulidingLocationWater_Update" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
 UpdateCommand="update [dbo].[tblBulidingLocationWater] set 

[Sort1] =@Sort1
where 
[Bulid_Loc_Water_ID]=@Bulid_Loc_Water_ID" UpdateCommandType="Text"   
    OnUpdated="sds_BulidingLocationWater_Update_Updated"
    ...
    <asp:Parameter  Name="Bulid_Loc_Water_ID" Type="Int32"  DefaultValue="0"/>
