<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="AnnounceHoliday" Codebehind="AnnounceHoliday.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text=" Holiday"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_HTitle" runat="server" class="form-control font1 b_textbox" MaxLength="100"  autocomplete="off"></asp:TextBox>
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_HTitle" runat="server" ID="RequiredFieldValidator2" 
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_DateFrom" runat="server" class="form-control font1 b_textbox"   TextMode="Date"  autocomplete="off"></asp:TextBox>
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_DateFrom" runat="server" ID="RequiredFieldValidator1" 
                                    ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label3" runat="server" Text="Date / To" ForeColor="Black" CssClass="lbl_style"></asp:Label><label class="text-danger m-0">*</label>
</label>

            
 <asp:TextBox ID="txt_DateTo" runat="server" class="form-control font1 b_textbox"   TextMode="Date"  autocomplete="off"></asp:TextBox>
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_DateTo" runat="server" ID="RequiredFieldValidator3" 
                                    ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="Photo" ForeColor="Black" CssClass="lbl_style"></asp:Label>
                         ...
                         <asp:Label ID="lbl_HPhoto" runat="server" Text=""></asp:Label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="Details" ForeColor="Black" CssClass="lbl_style"></asp:Label>
</label>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_Holiday_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
   <asp:Label ID="lbl_result_msg" runat="server" Text="Date Added succesfully ." Visible="False"></asp:Label>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Holiday_ID"
                                        DataSourceID="sds_Holiday" Width="100%" GridLines="None" PageSize="30">
                         ...
                         <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="Holiday_ID" InsertVisible="False"  Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Holiday_ID_GV" runat="server" Text='<%# Eval("Holiday_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelHTitle" runat="server" Text='<%# Eval("HTitle") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelDetails" runat="server" Text='<%# Eval("Details") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_Holiday" runat="server"
        ...
        SelectCommand="AnnounceHoliday_Select" DeleteCommand="AnnounceHoliday_Delete"
        DeleteCommandType="StoredProcedure" InsertCommand="AnnounceHoliday_Insert"
        InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure"
        UpdateCommand="AnnounceHoliday_Update" UpdateCommandType="StoredProcedure"
        
        oninserted="sds_Holiday_Inserted"
        OnUpdated="sds_Holiday_Updated"
        OnDeleted="sds_Holiday_Deleted"
        
        >
        <DeleteParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
   <asp:ControlParameter ControlID="lbl_Holiday_ID"  Name="Holiday_ID" Type="Int32" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </DeleteParameters>
        <InsertParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
      <asp:ControlParameter ControlID="txt_HTitle" Name="HTitle" Type="String" />
        ...
        <asp:ControlParameter ControlID="lbl_HPhoto" Name="HPhoto" Type="String" />
