<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="EducationSubjectPlan3" Codebehind="3EducationSubjectPlan.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="پلانی وانەی پەروەردەییەکان"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label6" runat="server" Text="کارمەند" CssClass="lbl_style"></asp:Label>
      ...
      <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_Staff" runat="server"   
        ...
        DataValueField = "Staff_ID" EmptyMessage="هەڵبژێرە"
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_educationSubjectPlan_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="educationSubjectPlan_ID"
                                        DataSourceID="sds_educationSubjectPlans" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#" >   
     ...
     <HeaderStyle Width="50px" />
                                            ...
                                            <asp:TemplateField HeaderText="" InsertVisible="False" Visible="false" >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_educationSubjectPlan_ID_GV" runat="server" Text='<%# Eval("educationSubjectPlan_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                               ...
                                               <asp:TemplateField HeaderText="  لە"   >
                                          ...
                                          <asp:TemplateField HeaderText="  بۆ"    >
    ...
    <asp:SqlDataSource ID="sds_educationSubjectPlans" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3EducationSubjectPlan_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3EducationSubjectPlan_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3EducationSubjectPlan_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3EducationSubjectPlan_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_educationSubjectPlan_ID" Name="educationSubjectPlan_ID" Type="Int32" />
