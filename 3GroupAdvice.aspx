<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="GroupAdvice3" Codebehind="3GroupAdvice.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="پێدانی ڕێنمایی بە کۆمەڵ"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="بابەتەکانی ڕێنمایی کردن" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_adviceTopics" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_adviceTopics" runat="server" ID="RequiredFieldValidator1" 
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="شوێن و ماوەی ڕێنمایی" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_locationAndDuration" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                       
                       <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_locationAndDuration" runat="server" ID="RequiredFieldValidator3" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_groupAdvice_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="groupAdvice_ID"
                                        DataSourceID="sds_groupAdvices" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_groupAdvice_ID_GV" runat="server" Text='<%# Eval("groupAdvice_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="بابەتەکانی ڕێنمایی کردن"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_adviceTopics" runat="server" Text='<%# Eval("adviceTopics") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="بەروار بۆ"    >
                                              ...
                                              <asp:TemplateField HeaderText="شوێن و ماوەی ڕێنمایی"    >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_locationAndDuration" runat="server" Text='<%# Eval("locationAndDuration") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_groupAdvices" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3GroupAdvice_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3GroupAdvice_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3GroupAdvice_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3GroupAdvice_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_groupAdvice_ID" Name="groupAdvice_ID" Type="Int32" />
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="txt_adviceTopics" Name="adviceTopics" Type="String" />
                ...
                <asp:ControlParameter ControlID="txt_dateTo"  Name="dateTo" DbType="Date" />
                  ...
                  <asp:ControlParameter ControlID="txt_locationAndDuration" Name="locationAndDuration" Type="String" />
