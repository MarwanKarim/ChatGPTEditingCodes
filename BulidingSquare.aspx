<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="BulidingSquare" Codebehind="BulidingSquare.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="گۆڕەپانی باخچە	"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_Bulid_SquareName" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>
    

 <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_Bulid_SquareName" runat="server" ID="RequiredFieldValidator2" 
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_Bulid_SquareNote" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>
    

<%-- <asp:RequiredFieldValidator ControlToValidate="txt_Bulid_SquareNote" runat="server" ID="RequiredFieldValidator3" 
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />--%>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_Bulid_Square_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                  </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Bulid_Square_ID"
                                        DataSourceID="sds_BulidingSquare" Width="100%" GridLines="None" PageSize="30">
    ...
    <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="Bulid_Square_ID" InsertVisible="False"   Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Bulid_Square_ID_GV" runat="server" Text='<%# Eval("Bulid_Square_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_SquareName" runat="server" Text='<%# Eval("Bulid_SquareName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_SquareNote" runat="server" Text='<%# Eval("Bulid_SquareNote") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" InitialValue="0" />--%>
   ...
   <!--   <script src="bootstrap/assets/libs/toastr/build/toastr.min.js"></script>-->
    ...
    <asp:SqlDataSource ID="sds_BulidingSquare" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        DeleteCommand="BulidingSquare_Delete"
        InsertCommand="BulidingSquare_Insert"
        SelectCommand="BulidingSquare_Select" SelectCommandType="StoredProcedure"
        UpdateCommand="BulidingSquare_Update" DeleteCommandType="StoredProcedure"
        InsertCommandType="StoredProcedure" UpdateCommandType="StoredProcedure"
        
     OnDeleted="sds_BulidingSquare_Deleted"

    OnUpdated="sds_BulidingSquare_Updated"
    OnInserted="sds_BulidingSquare_Inserted"
        >
        <DeleteParameters>
      <asp:Parameter ConvertEmptyStringToNull="True" DefaultValue="000" Direction="InputOutput" Name="ErrorMessage" Type="String" />

    <asp:ControlParameter ControlID="lbl_Bulid_Square_ID" Name="Bulid_Square_ID" Type="Int32" />
      ...
      <asp:ControlParameter ControlID="ddl_EducationalBoard"    Name="EducationalBoard_Fkey" Type="Int32" />
            <asp:ControlParameter ControlID="txt_Bulid_SquareNote"   Name="Bulid_SquareNote" Type="String" />
          <asp:ControlParameter ControlID="txt_Bulid_SquareName"   Name="Bulid_SquareName" Type="String" />
            <asp:ControlParameter ControlID="lbl_UserID"    Name="user_Insert" Type="Int32" DefaultValue="0" />
    ...
    <asp:ControlParameter ControlID="lbl_Bulid_Square_ID" Name="Bulid_Square_ID" Type="Int32" />
        ...
        <asp:SqlDataSource ID="sds_BulidingSquare_Update" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
 UpdateCommand="update [dbo].[tblBulidingSquare] set 

[Sort1] =@Sort1
where 
[Bulid_Square_ID]=@Bulid_Square_ID" UpdateCommandType="Text"   
    OnUpdated="sds_BulidingSquare_Update_Updated"
    ...
    <asp:Parameter  Name="Bulid_Square_ID" Type="Int32"  DefaultValue="0"/>
