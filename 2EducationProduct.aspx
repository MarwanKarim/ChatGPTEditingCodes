            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="بەرهەمەکانی بەشی پەروەردەیی"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="جۆری بەرهەم" CssClass="lbl_style"></asp:Label>
</label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="ناوی بەرهەم" CssClass="lbl_style"  ></asp:Label>
</label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="خاوەنی بیرۆکە" CssClass="lbl_style"  ></asp:Label>
</label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label7" runat="server" Text="کەسی داواکار" CssClass="lbl_style"  ></asp:Label>
</label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="شوێنی بەرهەمهێنان" CssClass="lbl_style"></asp:Label>
</label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label8" runat="server" Text="ئامانج لەم بەرهەمە" CssClass="lbl_style"></asp:Label>
</label>
                 ...
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText=" " InsertVisible="False" Visible="false" >
                                                ...
                                                <ItemTemplate>
                                                 ...
                                                 <asp:TemplateField HeaderText="جۆری بەرهەم"   >
                                                ...
                                                <ItemTemplate>
                                                 ...
                                                 <asp:TemplateField HeaderText="ناوی بەرهەم"   >
                                             ...
                                             <asp:TemplateField HeaderText="خاوەنی بیرۆکە"   >
                                               ...
                                               <asp:TemplateField HeaderText="کەسی داواکار"   >
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:TemplateField HeaderText="شوێنی بەرهەمهێنان"    >
...
<%--                                                       <asp:TemplateField HeaderText="ئامانج لەم بەرهەمە"    >
