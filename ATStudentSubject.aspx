<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="ATStudentSubject" Codebehind="ATStudentSubject.aspx.cs" %>
...
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="  Subject | Admission    " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_SubName" runat="server" class="form-control font1 b_textbox" MaxLength="200" autoComplete="off"></asp:TextBox>
    


         <asp:RequiredFieldValidator ControlToValidate="txt_SubName" runat="server" ID="RequiredFieldValidator2" 
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_Sub_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                  </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Sub_ID"
                                        DataSourceID="sds_ATStudentSubject" Width="100%" GridLines="None" PageSize="30">
    ...
    <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="Sub_ID" InsertVisible="False" SortExpression="PN_ID" Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Sub_ID_GV" runat="server" Text='<%# Eval("Sub_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<asp:SqlDataSource ID="sds_ATStudentSubject" runat="server" 
                              ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                           
                              InsertCommand="ATStudentSubject_Insert" InsertCommandType="StoredProcedure" 
                              DeleteCommand="ATStudentSubject_Delete" DeleteCommandType="StoredProcedure" 
                              SelectCommand="ATStudentSubject_Select" SelectCommandType="StoredProcedure"
                              UpdateCommand="ATStudentSubject_Update" UpdateCommandType="StoredProcedure" 
    OnInserted="sds_ATStudentSubject_Inserted"
    OnUpdated="sds_ATStudentSubject_Updated"
    OnDeleted="sds_ATStudentSubject_Deleted"
           ...
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
                  <asp:ControlParameter ControlID="lbl_Sub_ID" Name="Sub_ID" Type="Int32" />
                              ...
                              <InsertParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
       <asp:ControlParameter ControlID="txt_SubName" Name="SubName" Type="String" />
...
<asp:SqlDataSource ID="sds_ATStudentSubject_Active" runat="server" 
                              ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                           UpdateCommand="update tblATStudentSubject   set   SubActive=@SubActive,   user_update=@user_Insert
    , date_update=getdate() where  Sub_ID=@Sub_ID "    >
 ...
 <asp:Parameter Name="SubActive" Type="Byte" />
            <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
                              </UpdateParameters>
