<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="FeeDiscountReason" Codebehind="FeeDiscountReason.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="Discount Reason"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="Discount Reason " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_DiscountReasonName" runat="server" class="form-control font1 b_textbox" MaxLength="50"></asp:TextBox>
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_DiscountReasonName" runat="server" ID="RequiredFieldValidator2" 
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_DiscountReason_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
   <asp:Label ID="lbl_result_msg" runat="server" Text="Date Added succesfully ." Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="DiscountReason_ID"
                                        DataSourceID="sds_FeeDiscountReason" Width="100%" GridLines="None" PageSize="30">
    ...
    <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="DiscountReason_ID" InsertVisible="False" SortExpression="CatNo" Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_DiscountReason_ID_GV" runat="server" Text='<%# Eval("DiscountReason_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelDiscountReasonName" runat="server" Text='<%# Eval("DiscountReasonName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_FeeDiscountReason" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        SelectCommand="FeeDiscountReason_Select" DeleteCommand="FeeDiscountReason_Delete"
        DeleteCommandType="StoredProcedure" InsertCommand="FeeDiscountReason_Insert"
        InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure"
        UpdateCommand="FeeDiscountReason_Update" UpdateCommandType="StoredProcedure"
        
        OnInserted="sds_FeeDiscountReason_Inserted"
        OnUpdated="sds_FeeDiscountReason_Updated"
        OnDeleted  ="sds_FeeDiscountReason_Deleted"
        
        >
        <DeleteParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
          <asp:ControlParameter ControlID="lbl_DiscountReason_ID" Name="DiscountReason_ID" Type="Int32" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </DeleteParameters>
        <InsertParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
            <asp:ControlParameter ControlID="txt_DiscountReasonName" Name="DiscountReasonName" Type="String" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </InsertParameters>
