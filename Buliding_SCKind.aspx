<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="Buliding_SCKind" Codebehind="Buliding_SCKind.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="      باخچە | قوتابخانە	  "></asp:Label>
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_Bulid_SCKind_Name" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off" ValidationGroup="grpRegistration" ></asp:TextBox>
    

 <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_Bulid_SCKind_Name" runat="server" ID="RequiredFieldValidator2" 
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_Bulid_SCKind_Note" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off" ValidationGroup="grpRegistration" ></asp:TextBox>
    

<%-- <asp:RequiredFieldValidator ControlToValidate="txt_Bulid_SCKind_Note" runat="server" ID="RequiredFieldValidator3" 
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />--%>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_Bulid_SCKind_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                  </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Bulid_SCKind_ID"
                                        DataSourceID="sds_Buliding_SCKind" Width="100%" GridLines="None" PageSize="30">
    ...
    <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="Bulid_SCKind_ID" InsertVisible="False"   Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Bulid_SCKind_ID_GV" runat="server" Text='<%# Eval("Bulid_SCKind_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_SCKind_Name" runat="server" Text='<%# Eval("Bulid_SCKind_Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_SCKind_Note" runat="server" Text='<%# Eval("Bulid_SCKind_Note") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
 ...
 <asp:TextBox ID="txt_Sort1" runat="server" class="form-control font1 b_textbox" MaxLength="3" autoComplete="off"
  ...
  min="1"    
     ...
     Width="100px" ValidationGroup="grpRegistration3"
...
ValidationGroup="grpRegistration3"    Text="Required" ForeColor="Red" CssClass="font1" />
<%-- <asp:RequiredFieldValidator ControlToValidate="txt_Sort1" runat="server" ID="RequiredFieldValidator4" 
ValidationGroup="grpRegistration3"    Text="Required" ForeColor="Red" CssClass="font1" InitialValue="0" />--%>
    ...
    <asp:SqlDataSource ID="sds_Buliding_SCKind" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        DeleteCommand="Buliding_SCKind_Delete"
        InsertCommand="Buliding_SCKind_Insert"
        SelectCommand="Buliding_SCKind_Select" SelectCommandType="StoredProcedure"
        UpdateCommand="Buliding_SCKind_Update" DeleteCommandType="StoredProcedure"
        InsertCommandType="StoredProcedure" UpdateCommandType="StoredProcedure"
        
     OnDeleted="sds_Buliding_SCKind_Deleted"

    OnUpdated="sds_Buliding_SCKind_Updated"
    OnInserted="sds_Buliding_SCKind_Inserted"
        >
        <DeleteParameters>
      <asp:Parameter ConvertEmptyStringToNull="True" DefaultValue="000" Direction="InputOutput" Name="ErrorMessage" Type="String" />

    <asp:ControlParameter ControlID="lbl_Bulid_SCKind_ID" Name="Bulid_SCKind_ID" Type="Int32" />
      ...
      <asp:ControlParameter ControlID="ddl_EducationalBoard"    Name="EducationalBoard_Fkey" Type="Int32" />
            <asp:ControlParameter ControlID="txt_Bulid_SCKind_Name"   Name="Bulid_SCKind_Name" Type="String" />
          <asp:ControlParameter ControlID="txt_Bulid_SCKind_Note"   Name="Bulid_SCKind_Note" Type="String" />
            <asp:ControlParameter ControlID="lbl_UserID"    Name="user_Insert" Type="Int32" DefaultValue="0" />
    ...
    <asp:ControlParameter ControlID="lbl_Bulid_SCKind_ID" Name="Bulid_SCKind_ID" Type="Int32" />
        ...
        <asp:SqlDataSource ID="sds_Buliding_SCKind_Update" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
 UpdateCommand="update [dbo].[tblBuliding_SCKind] set 

[Sort1] =@Sort1
where 
[Bulid_SCKind_ID]=@Bulid_SCKind_ID" UpdateCommandType="Text"   
    OnUpdated="sds_Buliding_SCKind_Update_Updated"
    ...
    <asp:Parameter  Name="Bulid_SCKind_ID" Type="Int32"  DefaultValue="0"/>
