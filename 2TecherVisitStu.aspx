<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="TecherVisitStu2" Codebehind="2TecherVisitStu.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="سەردانیکردن"></asp:Label>
...
DataValueField = "Student_ID"
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="جۆری سەردان  " CssClass="lbl_style"></asp:Label>
</label>

            
     <asp:DropDownList ID="ddl_TypeVisit" runat="server" class="form-control font1 b_textbox"
     
         AppendDataBoundItems="True">

                           <asp:ListItem Text="هەڵبژێرە" Value="0"  />

    <asp:ListItem Text="سەردانیکردنی ماڵی منداڵ" Value="1"  />
           <asp:ListItem Text="سەردانیکردنی دایک و باوک" Value="2"  />
 
                     
                   </asp:DropDownList>

 
         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="ddl_TypeVisit" runat="server" ID="RequiredFieldValidator3" 
                                    ValidationGroup="grpRegistration"  InitialValue="0"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="ناوی سەردانیکار" CssClass="lbl_style"  ></asp:Label>
</label>

            
 <asp:TextBox ID="txt_VisitorName" runat="server" class="form-control font1 b_textbox" autoComplete="off" MaxLength="500"></asp:TextBox >
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_VisitorName" runat="server" ID="RequiredFieldValidator2" 
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_VisitDate" runat="server" class="form-control font1 b_textbox" autoComplete="off"  TextMode="Date"></asp:TextBox>
    
                  <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_VisitDate" runat="server" ID="RequiredFieldValidator4" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label8" runat="server" Text="ئامانجی سەردانیکردن" CssClass="lbl_style"></asp:Label>
</label>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_TecherVisitStuI_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="TecherVisitStuI_ID"
                                        DataSourceID="sds_2TecherVisitStu" Width="100%" GridLines="None" PageSize="30">
         ...
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" SortExpression="CatNo" Visible="False">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_TecherVisitStuI_ID_GV" runat="server" Text='<%# Eval("TecherVisitStuI_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                 ...
                                                 <asp:TemplateField HeaderText="جۆری سەردان"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_TypeVisit" runat="server" Text='<%# Eval("TypeVisit") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            
                                                 <asp:TemplateField HeaderText=" ناوی سەردانیکار"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_VisitorName" runat="server" Text='<%# Eval("VisitorName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="رۆژ و بەروار"    >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_VisitDate" runat="server" Text='<%# Eval("VisitDate","{0:yyyy-MM-dd}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>



                                                  <asp:TemplateField HeaderText="ئامانجی سەردانیکردن"    >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Note1" runat="server" Text='<%# Eval("Note1") %>'></asp:Label>
                                                       ...
                                                       <asp:TemplateField HeaderText="ئەنجامی سەردانیکردن"    >
 ...
 <asp:Label ID="lbl_date_insert" runat="server" Text='<%# Eval("date_insert") %>'></asp:Label>
    ...
    <!--    <script src="bootstrap/dist/js/custom.min.js"></script>-->
           ...
           <!--   <script src="bootstrap/assets/libs/toastr/build/toastr.min.js"></script>-->
            ...
            <asp:SqlDataSource ID="sds_2TecherVisitStu" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 
            SelectCommand="2TecherVisitStu_select" DeleteCommand="2TecherVisitStu_delete" 
                DeleteCommandType="StoredProcedure" InsertCommand="2TecherVisitStu_Insert" 
                InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure" 
                UpdateCommand="2TecherVisitStu_Update" UpdateCommandType="StoredProcedure">
                <SelectParameters>
            ...
            <asp:ControlParameter ControlID="lbl_TecherVisitStuI_ID" Name="TecherVisitStuI_ID" Type="Int32" />
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="ddl_student" Name="Student_Fkey" Type="Int32" />
                                ...
                                <asp:ControlParameter ControlID="ddl_TypeVisit" Name="TypeVisit" Type="Int32" />

                

               <asp:ControlParameter ControlID="txt_VisitorName" Name="VisitorName" Type="String" />
                <asp:ControlParameter ControlID="txt_VisitDate" DbType="Date" Name="VisitDate" />
