<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="WeeklyStudiedEducationLessons3" Codebehind="3WeeklyStudiedEducationLessons.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="ئەو وانە پەروەردەییانەی لەم هەفتەیەدا خوێندراون"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="ناوی وانەکان" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_nameOfLesson" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_nameOfLesson" runat="server" ID="RequiredFieldValidator1" 
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_weeklyStudiedEducationLesson_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="weeklyStudiedEducationLesson_ID"
                                        DataSourceID="sds_weeklyStudiedEducationLessons" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_weeklyStudiedEducationLesson_ID_GV" runat="server" Text='<%# Eval("weeklyStudiedEducationLesson_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="ناوی وانەکان"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_nameOfLesson" runat="server" Text='<%# Eval("nameOfLesson") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_weeklyStudiedEducationLessons" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3WeeklyStudiedEducationLessons_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3WeeklyStudiedEducationLessons_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3WeeklyStudiedEducationLessons_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3WeeklyStudiedEducationLessons_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_weeklyStudiedEducationLesson_ID" Name="weeklyStudiedEducationLesson_ID" Type="Int32" />
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="txt_nameOfLesson" Name="nameOfLesson" Type="String" />
