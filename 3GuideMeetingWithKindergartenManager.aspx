<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="GuideMeetingWithKindergartenManager3" Codebehind="3GuideMeetingWithKindergartenManager.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="کۆبوونەوەی رێنماییکار لەگەڵ بەڕێوەبەری باخچە"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="کاتی خایەنراو" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_meetingDuration" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_meetingDuration" runat="server" ID="RequiredFieldValidator1" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_guideMeetingWithKindergartenManager_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="guideMeetingWithKindergartenManager_ID"
                                        DataSourceID="sds_GuideMeetingWithKindergartenManagers" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_guideMeetingWithKindergartenManager_ID_GV" runat="server" Text='<%# Eval("guideMeetingWithKindergartenManager_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_GuideMeetingWithKindergartenManagers" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3GuideMeetingWithKindergartenManager_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3GuideMeetingWithKindergartenManager_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3GuideMeetingWithKindergartenManager_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3GuideMeetingWithKindergartenManager_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_guideMeetingWithKindergartenManager_ID" Name="guideMeetingWithKindergartenManager_ID" Type="Int32" />
