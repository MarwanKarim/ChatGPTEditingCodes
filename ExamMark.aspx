<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="ExamMark" Codebehind="ExamMark.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text=" Mark (Test)"></asp:Label>
...
<asp:SqlDataSource ID="sds_ExamMasterSub_ddl" runat="server" 
    ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
    SelectCommand="ExamMasterSubMark_Select_ddl" SelectCommandType="StoredProcedure">
    <SelectParameters>
            <asp:ControlParameter ControlID="ddl_Class" Name="Class_Fkey" DefaultValue="0" />
...
<%--       =============================== ama bo update ============================ --%>
    ...
    <asp:SqlDataSource ID="sds_ExamMark" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        SelectCommand="ExamMark_Select_Management" DeleteCommand="ExamMark_Delete"
