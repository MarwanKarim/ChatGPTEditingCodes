<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="AssetLocation" Codebehind="AssetLocation.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="Location    "></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text=" Location Name" CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_LocationName" runat="server" class="form-control font1 b_textbox" MaxLength="50"></asp:TextBox>
    


         <asp:RequiredFieldValidator ControlToValidate="txt_LocationName" runat="server" ID="RequiredFieldValidator2" 
...
&nbsp;&nbsp;
  <asp:Label ID="Label16" runat="server" Text="&nbsp;" CssClass="lbl_style"></asp:Label>
   ...
   <asp:Label ID="lbl_Location_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
   <asp:Label ID="lbl_result_msg" runat="server" Text="Date Added succesfully ." Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Location_ID"
                                        DataSourceID="sds_AssetLocation" Width="100%" GridLines="None" PageSize="30">
                                 ...
                                 <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/editt.png"
                                     ...
                                     OnClick="ImageButton1_Click1" ToolTip="Edit" Width="40px" />
                                            ...
                                            <asp:TemplateField HeaderText="Location_ID" InsertVisible="False" SortExpression="Category_ID" Visible="False">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Location_ID_GV" runat="server" Text='<%# Eval("Location_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_AssetLocation" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        SelectCommand="AssetLocation_Select" DeleteCommand="AssetLocation_Delete"
        DeleteCommandType="StoredProcedure" InsertCommand="AssetLocation_Insert"
        InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure"
        UpdateCommand="AssetLocation_Update" UpdateCommandType="StoredProcedure" 
        
        OnInserted="sds_AssetLocation_Inserted"
        OnUpdated="sds_AssetLocation_Updated"
        OnDeleted="sds_AssetLocation_Deleted"
 ...
 <asp:ControlParameter ControlID="lbl_Location_ID" Name="Location_ID" Type="Int32" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </DeleteParameters>
        <InsertParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
           <asp:ControlParameter ControlID="txt_LocationName" Name="LocationName" Type="String" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </InsertParameters>
