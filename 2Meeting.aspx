<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="Meeting2" Codebehind="2Meeting.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="کۆبوونەوەکان"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="جۆری کۆبوونەوە" CssClass="lbl_style"></asp:Label>
</label>

            
     <asp:DropDownList ID="ddl_meetingType" runat="server" class="form-control font1 b_textbox"
     
         DataSourceID="sds_meetingType_ddl"
         DataTextField="meetingName"
         DataValueField="meetingType_ID"
         ...
         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="ddl_meetingType" runat="server" ID="RequiredFieldValidator3" 
                                    ValidationGroup="grpRegistration"  InitialValue="0"    Text="Required" ForeColor="Red" CssClass="font1" />

               
                        <asp:SqlDataSource ID="sds_meetingType_ddl" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                  SelectCommand="  SELECT        meetingType_ID, meetingName
                                   FROM          tbl2MeetingType
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="ناوی ئەندامانی بەشداربوو" CssClass="lbl_style"  ></asp:Label>
</label>

            
 <asp:TextBox ID="txt_participantNames" runat="server" class="form-control font1 b_textbox" autoComplete="off" MaxLength="500"></asp:TextBox >
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_participantNames" runat="server" ID="RequiredFieldValidator2" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="سەرپەرشتی کۆبوونەوە" CssClass="lbl_style"  ></asp:Label>
</label>

            
 <asp:TextBox ID="txt_meetingSuperviser" runat="server" class="form-control font1 b_textbox" autoComplete="off" MaxLength="500"></asp:TextBox >
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_meetingSuperviser" runat="server" ID="RequiredFieldValidator5" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label7" runat="server" Text="کاتی خایەنراو" CssClass="lbl_style"  ></asp:Label>
</label>

            
 <asp:TextBox ID="txt_meetingDuration" runat="server" class="form-control font1 b_textbox" autoComplete="off" MaxLength="500"></asp:TextBox >
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_meetingDuration" runat="server" ID="RequiredFieldValidator6" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_meetingDate" runat="server" class="form-control font1 b_textbox" autoComplete="off"  TextMode="Date"></asp:TextBox>
    
                  <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_meetingDate" runat="server" ID="RequiredFieldValidator4" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="تەوەرەکانی کۆبوونەوە" CssClass="lbl_style"></asp:Label>
</label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label8" runat="server" Text="راسپاردەکانی کۆبوونەوە" CssClass="lbl_style"></asp:Label>
</label>
...
<script type="text/javascript">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="meeting_ID"
                                        DataSourceID="sds_meetings" Width="100%" GridLines="None" PageSize="30">
                 ...
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText=" " InsertVisible="False"  Visible="false">
                                                ...
                                                <ItemTemplate>
                                                 ...
                                                 <asp:TemplateField HeaderText="جۆری کۆبوونەوە"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_meetingType" runat="server" Text='<%# Eval("meetingName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            
                                                 <asp:TemplateField HeaderText="ناوی ئەندامانی بەشداربوو"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_participantNames" runat="server" Text='<%# Eval("participantNames") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                             <asp:TemplateField HeaderText="سەرپەرشتی کۆبوونەوە"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_meetingSuperviser" runat="server" Text='<%# Eval("meetingSuperviser") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                               <asp:TemplateField HeaderText="کاتی خایەنراو"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_meetingDuration" runat="server" Text='<%# Eval("meetingDuration") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="  بەروار"    >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_meetingDate" runat="server" Text='<%# Eval("meetingDate","{0:yyyy-MM-dd}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>



                                   <%--               <asp:TemplateField HeaderText="تەوەرەکانی کۆبوونەوە"    >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_note1" runat="server" Text='<%# Eval("note1") %>'></asp:Label>
                                                       ...
                                                       <asp:TemplateField HeaderText="راسپاردەکانی کۆبوونەوە"    >
 ...
 <asp:Label ID="lbl_date_insert" runat="server" Text='<%# Eval("date_insert") %>'></asp:Label>
    ...
    <asp:SqlDataSource ID="sds_meetings" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="2GeneralMeeting_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="2GeneralMeeting_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="2GeneralMeeting_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="2GeneralMeeting_Update"
 ...
 <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />        
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="ddl_Board" Name="EducationalBoard_Fkey" Type="Int32" />
                 <asp:ControlParameter ControlID="ddl_meetingType"  Name="meetingType_Fkey" Type="Int32" />
                <asp:ControlParameter ControlID="txt_participantNames" Name="participantNames" Type="String" />
                 <asp:ControlParameter ControlID="txt_meetingSuperviser"  Name="meetingSuperviser" Type="String" />
                <asp:ControlParameter ControlID="txt_meetingDuration"  Name="meetingDuration" Type="String" />
                <asp:ControlParameter ControlID="txt_meetingDate"  Name="meetingDate" DbType="Date" />
