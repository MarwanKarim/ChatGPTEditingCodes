<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="SpecialCaseInvestigation3" Codebehind="3SpecialCaseInvestigation.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="بەدواداچوون بۆ کەیسی تایبەت"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="ژمارەی کەیسە بینراوەکان" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_caseNumber" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_caseNumber" runat="server" ID="RequiredFieldValidator1" 
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="رێگاکانی بەکارهێنراون بۆ چارەسەرکردنی" CssClass="lbl_style"></asp:Label>
</label>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_specialCaseInvestigation_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="specialCaseInvestigation_ID"
                                        DataSourceID="sds_specialCaseInvestigations" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_specialCaseInvestigation_ID_GV" runat="server" Text='<%# Eval("specialCaseInvestigation_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="ژمارەی کەیسە بینراوەکان"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_caseNumber" runat="server" Text='<%# Eval("caseNumber") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="بەروار بۆ"    >
                                              ...
                                              <asp:TemplateField HeaderText="رێگاکانی بەکارهێنراون بۆ چارەسەرکردنی"    >
    ...
    <asp:SqlDataSource ID="sds_specialCaseInvestigations" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3specialCaseInvestigation_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3specialCaseInvestigation_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3specialCaseInvestigation_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3specialCaseInvestigation_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_specialCaseInvestigation_ID" Name="specialCaseInvestigation_ID" Type="Int32" />
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="txt_caseNumber" Name="caseNumber" Type="String" />
