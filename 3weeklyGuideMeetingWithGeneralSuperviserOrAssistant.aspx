<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="weeklyGuideMeetingWithGeneralSuperviserOrAssistant3" Codebehind="3weeklyGuideMeetingWithGeneralSuperviserOrAssistant.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="کۆبوونەوەکانی رێنماییکار لەگەڵ سەربەرشتیاری گشتی یان یاریدەدەرەکەی لەم هەفتەیەدا"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="ناوی سەرپەرشتیار" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_superviserName" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_superviserName" runat="server" ID="RequiredFieldValidator1" 
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="شوێنی کۆبوونەوە" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_placeOfMeeting" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_placeOfMeeting" runat="server" ID="RequiredFieldValidator3" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label7" runat="server" Text="تەوەرەکانی کۆبوونەوە" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_note1" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                               <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_note1" runat="server" ID="RequiredFieldValidator5" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="راسپاردەکانی کۆبوونەوەکە" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_note2" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                               <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_note2" runat="server" ID="RequiredFieldValidator6" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_weeklyGuideMeetingWithGeneralSuperOrAssist_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="weeklyGuideMeetingWithGeneralSuperOrAssist_ID"
                                        DataSourceID="sds_weeklyGuideMeetingWithGeneralSuperviserOrAssistants" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_weeklyGuideMeetingWithGeneralSuperOrAssist_ID_GV" runat="server" Text='<%# Eval("weeklyGuideMeetingWithGeneralSuperOrAssist_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="ناوی سەرپەرشتیار"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_superviserName" runat="server" Text='<%# Eval("superviserName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="بەروار بۆ"    >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_dateTo" runat="server" Text='<%# Eval("dateTo","{0:yyyy-MM-dd}") %>'></asp:Label>
                                                      ...
                                                      <asp:TemplateField HeaderText="شوێنی کۆبوونەوە"    >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_placeOfMeeting" runat="server" Text='<%# Eval("placeOfMeeting") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:TemplateField HeaderText="ڕاسپاردەکانی کۆبوونەوەکە"    >
    ...
    <asp:SqlDataSource ID="sds_weeklyGuideMeetingWithGeneralSuperviserOrAssistants" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3weeklyGuideMeetingWithGeneralSuperviserOrAssistant_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3weeklyGuideMeetingWithGeneralSuperviserOrAssistant_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3weeklyGuideMeetingWithGeneralSuperviserOrAssistant_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3weeklyGuideMeetingWithGeneralSuperviserOrAssistant_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_weeklyGuideMeetingWithGeneralSuperOrAssist_ID" Name="weeklyGuideMeetingWithGeneralSuperOrAssist_ID" Type="Int32" />
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="txt_superviserName" Name="superviserName" Type="String" />
                ...
                <asp:ControlParameter ControlID="txt_placeOfMeeting" Name="placeOfMeeting" Type="String" />
