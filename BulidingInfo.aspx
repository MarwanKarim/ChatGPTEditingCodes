<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="BulidingInfo" Codebehind="BulidingInfo.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="       ئامارە داتایی باڵاخانە	    "></asp:Label>
...
<asp:SqlDataSource ID="sds_EducationalBoard" runat="server" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="ناوی بەش" ForeColor="Black" CssClass="lbl_style"></asp:Label><label class="text-danger m-0">*</label>
</label>

            
 <asp:TextBox ID="txt_Bulid_InfoName" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>
    

 <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_Bulid_InfoName" runat="server" ID="RequiredFieldValidator2" 
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label3" runat="server" Text="ژمارەی ژوور یان بەش" ForeColor="Black" CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_Bulid_InfoNo" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>
    

<%-- <asp:RequiredFieldValidator ControlToValidate="txt_Bulid_InfoNo" runat="server" ID="RequiredFieldValidator3" 
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />--%>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="ڕوبەرەکەی" ForeColor="Black" CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txtBulid_InfoAera" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="تێبینی" ForeColor="Black" CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_Bulid_InfoNote" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off" TextMode="MultiLine" Height="35px"></asp:TextBox>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_Bulid_Info_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
   <asp:Label ID="lbl_result_msg" runat="server" Text="Date Added succesfully ." Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Bulid_Info_ID"
                                        DataSourceID="sds_BulidingInfo" Width="100%" GridLines="None" PageSize="30">
    ...
    <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="Bulid_Info_ID" InsertVisible="False"   Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Bulid_Info_ID_GV" runat="server" Text='<%# Eval("Bulid_Info_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                                 <asp:TemplateField HeaderText="   ناوی بەش"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_InfoName" runat="server" Text='<%# Eval("Bulid_InfoName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            
                                                 <asp:TemplateField HeaderText="   ژمارەی ژوور یان بەش"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_InfoNo" runat="server" Text='<%# Eval("Bulid_InfoNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            

                                                              <asp:TemplateField HeaderText="ڕوبەرەکەی"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_InfoAera" runat="server" Text='<%# Eval("Bulid_InfoAera") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBulid_InfoNote" runat="server" Text='<%# Eval("Bulid_InfoNote") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
ValidationGroup="grpRegistration2"    Text="Required" ForeColor="Red" CssClass="font1" />
<%-- <asp:RequiredFieldValidator ControlToValidate="txt_Sort1" runat="server" ID="RequiredFieldValidator4" 
ValidationGroup="grpRegistration2"    Text="Required" ForeColor="Red" CssClass="font1" InitialValue="0" />--%>
    ...
    <asp:SqlDataSource ID="sds_BulidingInfo" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        DeleteCommand="BulidingInfo_Delete"
        InsertCommand="BulidingInfo_Insert"
        SelectCommand="BulidingInfo_Select" SelectCommandType="StoredProcedure"
        UpdateCommand="BulidingInfo_Update" DeleteCommandType="StoredProcedure"
        InsertCommandType="StoredProcedure" UpdateCommandType="StoredProcedure"
        
     OnDeleted="sds_BulidingInfo_Deleted"

    OnUpdated="sds_BulidingInfo_Updated"
    OnInserted="sds_BulidingInfo_Inserted"
        >
        <DeleteParameters>
      <asp:Parameter ConvertEmptyStringToNull="True" DefaultValue="000" Direction="InputOutput" Name="ErrorMessage" Type="String" />

    <asp:ControlParameter ControlID="lbl_Bulid_Info_ID" Name="Bulid_Info_ID" Type="Int32" />
...
<asp:ControlParameter ControlID="txt_Bulid_InfoName"   Name="Bulid_InfoName" Type="String" />
<asp:ControlParameter ControlID="txt_Bulid_InfoNo"   Name="Bulid_InfoNo" Type="String" />
<asp:ControlParameter ControlID="txtBulid_InfoAera"   Name="Bulid_InfoAera" Type="String" />
<asp:ControlParameter ControlID="txt_Bulid_InfoNote"   Name="Bulid_InfoNote" Type="String" />
<asp:ControlParameter ControlID="lbl_UserID"    Name="user_Insert" Type="Int32" DefaultValue="0" />
...
<asp:ControlParameter ControlID="lbl_UserID"    Name="user_Insert" Type="Int32" DefaultValue="0" />
        ...
        <asp:SqlDataSource ID="sds_BulidingInfo_Update" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
 UpdateCommand="update [dbo].[tblBulidingInfo] set 

[Sort1] =@Sort1
where 
[Bulid_Info_ID]=@Bulid_Info_ID" UpdateCommandType="Text"   
    OnUpdated="sds_BulidingInfo_Update_Updated"
    ...
    <asp:Parameter  Name="Bulid_Info_ID" Type="Int32"  DefaultValue="0"/>
