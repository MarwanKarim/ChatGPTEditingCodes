<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="MonthlyCardNumbers4" Codebehind="4MonthlyCardNumbers.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="ژمارەی پێدانی کارتەکان"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <asp:TextBox ID="txt_dateOfGivingCards" runat="server" class="form-control font1 b_textbox" autoComplete="off"  TextMode="Date"></asp:TextBox>
    
                  <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_dateOfGivingCards" runat="server" ID="RequiredFieldValidator4" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label6" runat="server" Text="ناوی پۆل و لق" CssClass="lbl_style"></asp:Label>
</label>
      ...
      <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_Section" runat="server"   
                                    Label=""        DataSourceID = "sds_Section_ddl"
        DataTextField = "SectionName" EmptyMessage="هەڵبژێرە"
        DataValueField = "Section_ID"
         ...
         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="ddl_Section" runat="server" ID="RequiredFieldValidator1" 
                                    ValidationGroup="grpRegistration"     Text="Required" ForeColor="Red" CssClass="font1" />

              <asp:SqlDataSource ID="sds_Section_ddl" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                  SelectCommand="  SELECT        Section_ID, SectionName
                                   FROM           
                                   tblSetting_Section"
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="جۆری کارت" CssClass="lbl_style"></asp:Label>
</label>
      ...
      <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_studentCard" runat="server"   
                                    Label=""        DataSourceID = "sds_studentCard_ddl"
        DataTextField = "cardColor"
        DataValueField = "studentCard_ID" EmptyMessage="هەڵبژێرە"
                                       Height="200px"        MarkFirstMatch="True"  
                                 Width="100%"  AppendDataBoundItems="true"   Filter="Contains">
      </telerik:RadComboBox>
         ...
         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="ddl_studentCard" runat="server" ID="RequiredFieldValidator5" 
                                    ValidationGroup="grpRegistration"     Text="Required" ForeColor="Red" CssClass="font1" />

              <asp:SqlDataSource ID="sds_studentCard_ddl" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                  SelectCommand="  SELECT        studentCard_ID, cardColor
                                   FROM           
                                   tbl4StudentCards"
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="ژمارەی کارت" CssClass="lbl_style"  ></asp:Label>
</label>

            
 <asp:TextBox ID="txt_cardCount" runat="server" class="form-control font1 b_textbox" autoComplete="off" MaxLength="500"></asp:TextBox >
    


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_cardCount" runat="server" ID="RequiredFieldValidator3" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="تێبینی" CssClass="lbl_style"  ></asp:Label>
</label>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_monthlyCardNumbers_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="monthlyCardNumbers_ID"
                                        DataSourceID="sds_monthlyCardNumbers" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_monthlyCardNumbers_ID_GV" runat="server" Text='<%# Eval("monthlyCardNumbers_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_dateOfGivingCards" runat="server" Text='<%# Eval("dateOfGivingCards","{0:yyyy-MM-dd}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                                <asp:TemplateField HeaderText="ناوی پۆل و لق"   >
                                                ...
                                                <asp:TemplateField HeaderText="جۆری کارت"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_studentCard" runat="server" Text='<%# Eval("cardColor") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>



                                                    <asp:TemplateField HeaderText="ژمارەی کارت"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_cardCount" runat="server" Text='<%# Eval("cardCount") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_monthlyCardNumbers" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="4MonthlyCardNumbers_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="4MonthlyCardNumbers_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="4MonthlyCardNumbers_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="4MonthlyCardNumbers_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_monthlyCardNumbers_ID" Name="monthlyCardNumbers_ID" Type="Int32" />
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="txt_dateOfGivingCards"  Name="dateOfGivingCards" DbType="Date" />

                <asp:ControlParameter ControlID="ddl_Section" Name="Section_Fkey" Type="Int32" />

                  <asp:ControlParameter ControlID="ddl_studentCard" Name="studentCard_Fkey" Type="Int32" />

                   <asp:ControlParameter ControlID="txt_cardCount"  Name="cardCount" Type="String" />
