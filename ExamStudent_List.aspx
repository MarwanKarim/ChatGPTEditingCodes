<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="ExamStudent_List" Codebehind="ExamStudent_List.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="Certificate List | School  "></asp:Label>
...
<asp:SqlDataSource ID="sds_EducationalBoard" runat="server" 
    ...
    <SelectParameters>
              <asp:Parameter  Name="BoardTypeID" Type="Int32" DefaultValue="2" />
  ...
  <asp:Label ID="Label16" runat="server" Text="&nbsp;" CssClass="lbl_style"></asp:Label>
    ...
    <div class="dropdown-menu animated flipInY">
           <a   class="dropdown-item"  target="_blank" 
             href="ExamMark_Card_MainHalfYearly_Report.aspx?Student_ID=<%# Eval("Student_ID") %>&AcademicYear_Fkey=<%# Eval("AcademicYear_Fkey") %>">
             <i class="far fa-id-card"></i>    First Term  Report CARD (Grade)</a>   
        
        
            <a   class="dropdown-item"  target="_blank" 
              href="ExamMark_Card_MainYearly_Report.aspx?Student_ID=<%# Eval("Student_ID") %>&AcademicYear_Fkey=<%# Eval("AcademicYear_Fkey") %>">
              <i class="far fa-id-card"></i> YEAR-REPORT CARD (Grade)  </a>
        
        <a   class="dropdown-item"  target="_blank" 
            href="ExamMark_Card_Main_Report_Kurdi.aspx?Student_ID=<%# Eval("Student_ID") %>&AcademicYear_Fkey=<%# Eval("AcademicYear_Fkey") %>">
            <i class="far fa-id-card"></i>
      YEARLY-REPORT CARD (mark)    </a>
           
     
  
        <a   class="dropdown-item"  target="_blank" 
            href="ExamMark_Card_Main_Report_Kurdi_Class_9.aspx?Student_ID=<%# Eval("Student_ID") %>&AcademicYear_Fkey=<%# Eval("AcademicYear_Fkey") %>">
            <i class="far fa-id-card"></i>
      YEARLY-REPORT CARD (mark)   | Class 9 </a>
