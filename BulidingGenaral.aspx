<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="BulidingGenaral" CodeBehind="BulidingGenaral.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="  زانیاری بیناکانی وایز  "></asp:Label>
  ...
  <asp:Label ID="Label1" runat="server" Text="Board" ForeColor="Black" CssClass="lbl_style"></asp:Label><label class="text-danger m-0">*</label>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom02">
                                            &nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="Question" ForeColor="Black" CssClass="lbl_style"></asp:Label><label class="text-danger m-0">*</label>
                                        </label>


                                        <asp:TextBox ID="txt_Bulid_Name" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>


                                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_Bulid_Name" runat="server" ID="RequiredFieldValidator2"
  ...
  <asp:Label ID="Label3" runat="server" Text="Answer" ForeColor="Black" CssClass="lbl_style"></asp:Label>
                                        ...
                                        <asp:TextBox ID="txt_Bulid_Details" runat="server" class="form-control font1 b_textbox" MaxLength="1000" autoComplete="off"></asp:TextBox>


                                        <%-- <asp:RequiredFieldValidator ControlToValidate="txt_Bulid_Details" runat="server" ID="RequiredFieldValidator3" 
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />--%>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <label for="validationCustom02">
                                            &nbsp;&nbsp;
  <asp:Label ID="Label16" runat="server" Text="&nbsp;" ForeColor="Black" CssClass="lbl_style"></asp:Label>
                                        </label>
                                        ...
                                        <asp:Label ID="lbl_Bulid_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive font1" style="overflow-x: scroll">
                                            ...
                                            <asp:GridView ID="Gridview1"
                                                ...
                                                CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Bulid_ID"
                                                DataSourceID="sds_BulidingGenaral" Width="100%" GridLines="None" PageSize="30">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Bulid_ID" InsertVisible="False" Visible="False">

                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Bulid_ID_GV" runat="server" Text='<%# Eval("Bulid_ID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Qustion">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="LabelBulid_Name" runat="server" Text='<%# Eval("Bulid_Name") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Answer">
                                                        <ItemTemplate>
                                                            <asp:Label ID="LabelBulid_Details" runat="server" Text='<%# Eval("Bulid_Details") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
...
ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" InitialValue="0" />--%>
    ...
    <asp:SqlDataSource ID="sds_BulidingGenaral" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        DeleteCommand="BulidingGenaral_Delete"
        InsertCommand="BulidingGenaral_Insert"
        SelectCommand="BulidingGenaral_Select" SelectCommandType="StoredProcedure"
        UpdateCommand="BulidingGenaral_Update" DeleteCommandType="StoredProcedure"
        InsertCommandType="StoredProcedure" UpdateCommandType="StoredProcedure"
        OnDeleted="sds_BulidingGenaral_Deleted"
        OnUpdated="sds_BulidingGenaral_Updated"
        OnInserted="sds_BulidingGenaral_Inserted">
        <DeleteParameters>
            <asp:Parameter ConvertEmptyStringToNull="True" DefaultValue="000" Direction="InputOutput" Name="ErrorMessage" Type="String" />

            <asp:ControlParameter ControlID="lbl_Bulid_ID" Name="Bulid_ID" Type="Int32" />
        ...
        <InsertParameters>
            ...
            <asp:ControlParameter ControlID="txt_Bulid_Name" Name="Bulid_Name" Type="String" />
            <asp:ControlParameter ControlID="txt_Bulid_Details" Name="Bulid_Details" Type="String" />
            <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
    ...
    <asp:SqlDataSource ID="sds_BulidingGenaral_Update" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        UpdateCommand="update [dbo].[tblBulidingGenaral] set 

[Sort1] =@Sort1
where 
[Bulid_ID]=@Bulid_ID"
        UpdateCommandType="Text"
        OnUpdated="sds_BulidingGenaral_Update_Updated">


        <UpdateParameters>


            <asp:Parameter Name="Bulid_ID" Type="Int32" DefaultValue="0" />
