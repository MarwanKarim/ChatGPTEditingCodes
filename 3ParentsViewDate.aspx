<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="ParentsViewDate3" Codebehind="3ParentsViewDate.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="بەرواری بینینی دایباب"></asp:Label>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_parentsViewDate_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="parentsViewDate_ID"
                                        DataSourceID="sds_parentsViewDate" Width="100%" GridLines="None" PageSize="30">
         ...
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_parentsViewDate_ID_GV" runat="server" Text='<%# Eval("parentsViewDate_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
 ...
 <telerik:RadGrid RenderMode="Mobile" ID="RadGrid1" GridLines="None" runat="server" 
  ...
  AllowAutomaticUpdates="True"  CssClass="GV_style" AllowPaging="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataKeyNames="parentsViewDetails_ID" AllowAutomaticUpdates="true"
                DataSourceID="sds_parentsViewDetails" HorizontalAlign="NotSet" EditMode="Batch" AutoGenerateColumns="False" 
                 >
                ...
                <Columns>
                    ...
                    <%--======================================================================--%>
                            <telerik:GridTemplateColumn HeaderText="هۆکاری بینین" DefaultInsertValue="parentsReasonView" 
                                HeaderStyle-Width="200px" UniqueName="parentsReasonView" DataField="parentsView">
                        <ItemTemplate>
                            <%# Eval("parentsReasonView") %>
                        </ItemTemplate>
                       ...
                       <telerik:GridTemplateColumn HeaderText="ژمارە" DefaultInsertValue="parentsNumber" HeaderStyle-Width="220px" 
                           UniqueName="parentsNumber" DataField="parentsNumber">
                        <ItemTemplate>
                       
                            <asp:Label ID="lblparentsNumber" runat="server" Text='<%# Eval("parentsNumber") %>'></asp:Label>
                       <%-- <asp:Label ID="lblBookRegNo" runat="server" Text='<%# Eval("BookRegNo") %>'></asp:Label>--%>
                           ...
                           <EditItemTemplate>
                                                       ...
                                                       <asp:TextBox ID="txt_parentsNumber" runat="server" class="form-control font1 b_textbox"
                                            onkeypress="return(KeyPressOrder(this,event))" 
                                               MaxLength="4" autocomplete="off"></asp:TextBox>


         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_parentsNumber" runat="server" ID="RequiredFieldValidator13"  SetFocusOnError="true"
    ...
    <asp:SqlDataSource ID="sds_parentsViewDate" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3ParentsViewDate_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3ParentsViewDate_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3ParentsViewDate_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3ParentsViewDate_Update"
        ...
        <SelectParameters>
            ...
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_parentsViewDate_ID" Name="parentsViewDate_ID" Type="Int32" />
    ...
    <asp:SqlDataSource ID="sds_parentsViewDetails" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3ParentsViewDetails_Select"
        SelectCommandType="StoredProcedure"
        ...
        InsertCommand="3ParentsViewDetails_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3ParentsViewDetails_Update"
        UpdateCommandType="StoredProcedure">
        <SelectParameters>

                <asp:SessionParameter SessionField="parentsViewDate_Fkey" Name="parentsViewDate_Fkey" Type="Int32" />
            ...
            <InsertParameters>
                    ...
                    <asp:Parameter   Name="parentsViewDate_Fkey" Type="Int32" />
            ...
            <UpdateParameters>
                ...
                <asp:Parameter   Name="parentsViewDetails_ID" Type="Int32" />

                    <asp:Parameter   Name="parentsNumber" Type="Int32" />
