<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="WeeklyJobSetting3" Codebehind="3WeeklyJobSetting.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="ڕێکخستنی کاری یاریدەدەری سەرپەرشتیار  "></asp:Label>
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="کارەکان" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_jobName" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_jobName" runat="server" ID="RequiredFieldValidator3" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="Status" CssClass="lbl_style"></asp:Label>
</label>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_weeklyJobSetting_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="weeklyJobSetting_ID"
                                        DataSourceID="sds_weeklyJobSettings" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
     ...
     <HeaderStyle Width="50px" />
                                            ...
                                            <asp:TemplateField HeaderText=""   Visible="false" >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_weeklyJobSetting_ID_GV" runat="server" Text='<%# Eval("weeklyJobSetting_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_jobName" runat="server" Text='<%# Eval("jobName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
  ...
  min="1"   
    ...
    <asp:SqlDataSource ID="sds_weeklyJobSettings" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3WeeklyJobSetting_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3WeeklyJobSetting_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3WeeklyJobSetting_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3WeeklyJobSetting_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_weeklyJobSetting_ID" Name="weeklyJobSetting_ID" Type="Int32" />
            ...
            <InsertParameters>
               ...
               <asp:ControlParameter ControlID="txt_jobName"  Name="jobName" Type="String" />
