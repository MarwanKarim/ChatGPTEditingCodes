<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="ATStudentResult" Codebehind="ATStudentResult.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text=" Subject | Admission  "></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="  Student " CssClass="lbl_style"></asp:Label>
</label>

                 <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_Student" runat="server"   
                                    Label="" DataSourceID="sds_Student" DataTextField="StudentNameE"
                                 ...
                                 Width="100%"  AppendDataBoundItems="true"   Filter="Contains">
                                    <Items>
                                        <telerik:RadComboBoxItem Value="0" Text="Choose" />
                                    </Items>
      </telerik:RadComboBox>
                        ...
                        <asp:SqlDataSource ID="sds_Student" runat="server"
                                    ...
                                    SelectCommand="SELECT        SBReg_ID, StudentNameE
FROM            tblATStudentReg where AcademicYear_Fkey=@AcademicYear_Fkey"  >
                            <SelectParameters>
                                ...
                                <asp:ControlParameter ControlID="lbl_AcademicYear_ID" Name="AcademicYear_Fkey" Type="Int32" />
                                 ...
                                 <asp:RequiredFieldValidator ControlToValidate="ddl_Student" runat="server" ID="RequiredFieldValidator1" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="  Subject " CssClass="lbl_style"></asp:Label>
</label>

            
                  <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_Subject" runat="server"   
                                    Label="" DataSourceID="sds_Subject" DataTextField="SubName"
                                       Height="200px"     HighlightTemplatedItems="true"     DataValueField="Sub_ID" MarkFirstMatch="True"  
                                 Width="100%"  AppendDataBoundItems="true"   Filter="Contains">
                                    <Items>
                                        <telerik:RadComboBoxItem Value="0" Text="Choose" />
                                    </Items>
                        ...
                        <asp:SqlDataSource ID="sds_Subject" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                                    SelectCommand="SELECT        Sub_ID, SubName 
FROM            tblATStudentSubject
WHERE        (isnull(SubActive,1) = 1)"  >
                      
                                   
                                </asp:SqlDataSource>
    
                                 <asp:RequiredFieldValidator ControlToValidate="ddl_Subject" runat="server" ID="RequiredFieldValidator2" 
                                    ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label3" runat="server" Text="  Degree     " CssClass="lbl_style"></asp:Label>
</label>

          
 
 <asp:TextBox ID="txt_Degree" runat="server" class="form-control font1 b_textbox"   MaxLength="3" autocomplete="off"
      onkeypress="return(KeyPressOrder(this,event))" 
     ></asp:TextBox>
   
        <asp:RequiredFieldValidator ControlToValidate="txt_Degree" runat="server" ID="RequiredFieldValidator9"  SetFocusOnError="true"
                                    ValidationGroup="grpRegistration"      Text="Required" ForeColor="Red" CssClass="font1" />  
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_ATSResult_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                  </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="ATSResult_ID"
                                        DataSourceID="sds_ATStudentResult" Width="100%" GridLines="None" PageSize="30">
    ...
    <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="ATSResult_ID" InsertVisible="False" SortExpression="PN_ID" Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_ATSResult_ID_GV" runat="server" Text='<%# Eval("ATSResult_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelSubName" runat="server" Text='<%# Eval("SubName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelDegree" runat="server" Text='<%# Eval("Degree") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<asp:SqlDataSource ID="sds_ATStudentResult" runat="server" 
                              ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                           
                              InsertCommand="ATStudentResult_Insert" InsertCommandType="StoredProcedure" 
                              DeleteCommand="ATStudentResult_Delete" DeleteCommandType="StoredProcedure" 
                              SelectCommand="ATStudentResult_Select" SelectCommandType="StoredProcedure"
                              UpdateCommand="ATStudentResult_Update" UpdateCommandType="StoredProcedure" 
    OnInserted="sds_ATStudentResult_Inserted"
    OnUpdated="sds_ATStudentResult_Updated"
    OnDeleted="sds_ATStudentResult_Deleted"
           ...
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
                  <asp:ControlParameter ControlID="lbl_Sub_ID" Name="Sub_ID" Type="Int32" />
                                  <asp:Parameter Name="user_Insert" Type="Int32" />
                              </DeleteParameters>
                           
                              <InsertParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
       <asp:ControlParameter ControlID="ddl_Student" Name="SBReg_Fkey" Type="String" />
    <asp:ControlParameter ControlID="ddl_Subject" Name="Sub_Fkey" Type="String" />
    <asp:ControlParameter ControlID="txt_Degree" Name="Degree" Type="String" />
             ...
             <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
                              ...
                              <UpdateParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
                  <asp:ControlParameter ControlID="lbl_ATSResult_ID" Name="ATSResult_ID" Type="Int32" />
       <asp:ControlParameter ControlID="ddl_Student" Name="SBReg_Fkey" Type="String" />
    <asp:ControlParameter ControlID="ddl_Subject" Name="Sub_Fkey" Type="String" />
    <asp:ControlParameter ControlID="txt_Degree" Name="Degree" Type="String" />
