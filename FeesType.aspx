<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="FeesType" Codebehind="FeesType.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="Fees Type"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="Fees Type English " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_FeesTypeNameE" runat="server" class="form-control font1 b_textbox" MaxLength="200"></asp:TextBox>
    
  <asp:RequiredFieldValidator ControlToValidate="txt_FeesTypeNameE" runat="server" ID="RequiredFieldValidator2" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="Fees Type Kurdish " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_FeesTypeNamek" runat="server" class="form-control font1 b_textbox" MaxLength="200"></asp:TextBox>
    
  <asp:RequiredFieldValidator ControlToValidate="txt_FeesTypeNamek" runat="server" ID="RequiredFieldValidator1" 
                                    ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label3" runat="server" Text="Fees Type Arabic " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_FeesTypeNameA" runat="server" class="form-control font1 b_textbox" MaxLength="200"></asp:TextBox>
    
  <asp:RequiredFieldValidator ControlToValidate="txt_FeesTypeNameA" runat="server" ID="RequiredFieldValidator3" 
                                    ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
<script type="text/javascript">
            function Validate() {
                ...
                return false;
                    ...
                    CssClass="btn  btn-danger " OnClick="btn_delete_Click"     ValidationGroup="grpRegistration111" 
   ...
   <asp:Label ID="lbl_FeesType_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="FeesType_ID"
                                        DataSourceID="sds_FeesType" Width="100%" GridLines="None" PageSize="30">
...
formnovalidate ><i style="font-size:16px !important; color:#000"  class="m-r-10 mdi mdi-grease-pencil"></i></asp:LinkButton>
                                            ...
                                            <asp:TemplateField HeaderText="FeesType_ID" InsertVisible="False" SortExpression="CatNo" Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_FeesType_ID_GV" runat="server" Text='<%# Eval("FeesType_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelFeesTypeNam333e" runat="server" Text='<%# Eval("FeesTypeNameE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                      
                                                 <asp:TemplateField HeaderText="کوردی   "   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelFeesTypeNamek" runat="server" Text='<%# Eval("FeesTypeNameK") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            
                                                 <asp:TemplateField HeaderText="عەرەبی   "   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelFeesTypeNameA" runat="server" Text='<%# Eval("FeesTypeNameA") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_FeesType" runat="server"
        ...
        SelectCommand="FeesType_Select" DeleteCommand="FeesType_Delete"
        DeleteCommandType="StoredProcedure" InsertCommand="FeesType_Insert"
        InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure"
        UpdateCommand="FeesType_Update" UpdateCommandType="StoredProcedure"
        
        OnInserted="sds_FeesType_Inserted"
        OnUpdated="sds_FeesType_Updated"
        OnDeleted="sds_FeesType_Deleted"
        
        
        >
        <DeleteParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
         <asp:ControlParameter ControlID="lbl_FeesType_ID" Name="FeesType_ID" Type="Int32" />
        ...
        <InsertParameters>
           ...
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
                ...
                <asp:ControlParameter ControlID="txt_FeesTypeNameE" Name="FeesTypeNameE" Type="String" />
                <asp:ControlParameter ControlID="txt_FeesTypeNameK" Name="FeesTypeNameK" Type="String" />
                <asp:ControlParameter ControlID="txt_FeesTypeNameA" Name="FeesTypeNameA" Type="String" />
