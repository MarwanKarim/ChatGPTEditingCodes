<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="FeeVoucharPaymentDiscount1" Codebehind="1FeeVoucharPaymentDiscount.aspx.cs" %>
  ...
  <asp:Label ID="Label6" runat="server" Text="  Student Name  " CssClass="lbl_style"></asp:Label>
            ...
            <asp:ControlParameter ControlID="lbl_FeeVoucher_Fkey" Name="FeeVoucher_Fkey" Type="Int32" />
                            ...
                            <div class="col-md-2 mb-3">
                                <label for="validationCustom02">
                                    &nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="Discount /Reason" CssClass="lbl_style"></asp:Label>
                                </label>

                                <%--           --%>

                                <asp:DropDownList ID="ddl_Discount" runat="server" class="form-control font1 b_textbox"
                                    AppendDataBoundItems="True"   
                                    DataSourceID="sds_discount" DataTextField="DiscountReasonName" DataValueField="DiscountReason_ID" >

                                    <asp:ListItem Value="0" Text="choose" />
                                </asp:DropDownList>

                                <asp:SqlDataSource ID="sds_discount" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
                                    SelectCommand="SELECT DiscountReason_ID, DiscountReasonName FROM tblFeeDiscountReason" SelectCommandType="Text">
                                    <SelectParameters>
                                        ...
                                        <asp:RequiredFieldValidator ControlToValidate="ddl_Discount" runat="server" ID="RequiredFieldValidator1"
    ...
    <asp:SqlDataSource ID="sds_FeeVoucharDetails_Payment" runat="server"
       ...
       OnUpdated="sds_FeeVoucharDetails_Payment_Updated"
        ...
        <InsertParameters>
            ...
            <asp:ControlParameter ControlID="lbl_FeeVoucher_Fkey" Name="FeeVoucher_Fkey" Type="Int32" />
              <asp:ControlParameter ControlID="ddl_Discount"  Name="DiscountReason_Fkey" Type="Int32" DefaultValue="0" />
            <asp:Parameter Name="VoucharDetailsType" Type="String"  DefaultValue="DisS"/>
