<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="ContactTelegramBot" Codebehind="ContactTelegramBot.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="Telegram Bot"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="Bot Name" CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_BotName" runat="server" class="form-control font1 b_textbox" MaxLength="100"></asp:TextBox>
    


         <asp:RequiredFieldValidator ControlToValidate="txt_BotName" runat="server" ID="RequiredFieldValidator2" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="Token  " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_BotToken" runat="server" class="form-control font1 b_textbox" MaxLength="1000"></asp:TextBox>
    


         <asp:RequiredFieldValidator ControlToValidate="txt_BotToken" runat="server" ID="RequiredFieldValidator1" 
                                    ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
  ...
  <asp:Label ID="Label16" runat="server" Text="&nbsp;" CssClass="lbl_style"></asp:Label>
            ...
            <div class="form-group"> 
                                        ...
                                        <asp:Button ID="btn_Update" runat="server" Text=" Save"   CssClass="btn  btn-warning font1"
                                            ...
                                            OnClientClick="javascript:return confirm('are sure save?');" Visible="False" />
                                        ...
                                        <asp:Button ID="btn_Delete" runat="server" Text="Delete"   CssClass="btn   waves-light btn-danger font1"
                                            ...
                                            OnClientClick="javascript:return confirm('  are you sure delete  ?');" Visible="False" />
   ...
   <asp:Label ID="lbl_Bot_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
   <asp:Label ID="lbl_result_msg" runat="server" Text="Date Added succesfully ." Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="Bot_ID"
                                        DataSourceID="sds_ContactTelegramBot" Width="100%" GridLines="None" PageSize="30">
                                 ...
                                 <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/editt.png"
                                     ...
                                     OnClick="ImageButton1_Click1" ToolTip="Edit" Width="40px" />
                                            ...
                                            <asp:TemplateField HeaderText="Bot_ID" InsertVisible="False" SortExpression="CatNo" Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_Bot_ID_GV" runat="server" Text='<%# Eval("Bot_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                                 <asp:TemplateField HeaderText="Bot Name"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBotName" runat="server" Text='<%# Eval("BotName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                      
                                         
                                                 <asp:TemplateField HeaderText="Bot Token"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelBotToken" runat="server" Text='<%# Eval("BotToken") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_ContactTelegramBot" runat="server"
        ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>"
        SelectCommand="ContactTelegramBot_Select" DeleteCommand="ContactTelegramBot_Delete"
        DeleteCommandType="StoredProcedure" InsertCommand="ContactTelegramBot_Insert"
        InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure"
        UpdateCommand="ContactTelegramBot_Update" UpdateCommandType="StoredProcedure"
        
        
      OnInserted="sds_ContactTelegramBot_Inserted"
        OnUpdated="sds_ContactTelegramBot_Updated"

        OnDeleted="sds_ContactTelegramBot_Deleted"
        
        >
        <DeleteParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
     <asp:ControlParameter ControlID="lbl_Bot_ID" Name="Bot_ID" Type="Int32" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </DeleteParameters>
        <InsertParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
          <asp:ControlParameter ControlID="txt_BotName" Name="BotName" Type="String" />
         <asp:ControlParameter ControlID="txt_BotToken" Name="BotToken" Type="String" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </InsertParameters>
