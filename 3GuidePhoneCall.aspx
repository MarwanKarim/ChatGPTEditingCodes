<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="GuidePhoneCall3" Codebehind="3GuidePhoneCall.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="پەیوەندی"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label4" runat="server" Text="کارەکان" CssClass="lbl_style"></asp:Label>
</label>
    ...
    <%--    DataTextField = "StaffName"
      ...
      <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_upcomingCalls" runat="server"   
                                    Label=""    
                                        MarkFirstMatch="True"  
                                 Width="100%"  AppendDataBoundItems="true"   Filter="Contains">
                                    <Items>
                                        <telerik:RadComboBoxItem Value="0" Text="پەیوەندی هاتوو" />
                                         <telerik:RadComboBoxItem Value="1" Text="پەیوەندی رۆیشتوو" />
         ...
         <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="ddl_upcomingCalls" runat="server" ID="RequiredFieldValidator5" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="ژمارەی پەیوەندییەکان" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_numberOfCalls" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_numberOfCalls" runat="server" ID="RequiredFieldValidator1" 
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="هۆکار" CssClass="lbl_style"></asp:Label>
</label>
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label6" runat="server" Text="چۆنییەتی بەدواداچوون" CssClass="lbl_style"></asp:Label>
</label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label7" runat="server" Text="تێبینی" CssClass="lbl_style"></asp:Label>
          ...
          <asp:TextBox ID="txt_note3" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_guidePhoneCall_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="guidePhoneCall_ID"
                                        DataSourceID="sds_guidePhoneCalls" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_guidePhoneCall_ID_GV" runat="server" Text='<%# Eval("guidePhoneCall_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="کارەکان"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_upcomingCalls" runat="server" Text='<%# Eval("upcomingCalls") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>


                                             <asp:TemplateField HeaderText="ژمارەی پەیوەندییەکان"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_numberOfCalls" runat="server" Text='<%# Eval("numberOfCalls") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="بەروار بۆ"    >
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:TemplateField HeaderText="هۆکار"    >
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:TemplateField HeaderText="چۆنییەتی بەدواداچوون"    >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_note3" runat="server" Text='<%# Eval("note3") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_guidePhoneCalls" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3GuidePhoneCall_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3GuidePhoneCall_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3GuidePhoneCall_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3GuidePhoneCall_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_guidePhoneCall_ID" Name="guidePhoneCall_ID" Type="Int32" />
            ...
            <InsertParameters>
                  ...
                  <asp:ControlParameter ControlID="ddl_upcomingCalls" Name="upcomingCalls" Type="Int32" />
                <asp:ControlParameter ControlID="txt_numberOfCalls" Name="numberOfCalls" Type="String" />
               ...
               <asp:ControlParameter ControlID="txt_note1"  Name="note1" Type="String" />
                 ...
                 <asp:ControlParameter ControlID="txt_note3"  Name="note3" Type="String" />
