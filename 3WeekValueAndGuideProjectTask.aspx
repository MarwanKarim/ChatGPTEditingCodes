<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="WeekValueAndGuideProjectTask3" Codebehind="3WeekValueAndGuideProjectTask.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="بەهای هەفتە و کاری ڕێنمایکار"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label5" runat="server" Text="ناوی بەهای ئەم هەفتەیە" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_weekValueName" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_weekValueName" runat="server" ID="RequiredFieldValidator1" 
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="چالاکی ڕێنماییکار بۆ ئەم بەهایە" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_guideActivity" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                       
                       <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_guideActivity" runat="server" ID="RequiredFieldValidator3" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_weekValueAndGuideProjectTask_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="weekValueAndGuideProjectTask_ID"
                                        DataSourceID="sds_WeekValueAndGuideProjectTasks" Width="100%" GridLines="None" PageSize="30">
 ...
 <asp:TemplateField HeaderText="#">   
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_weekValueAndGuideProjectTask_ID_GV" runat="server" Text='<%# Eval("weekValueAndGuideProjectTask_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="ناوی بەهای ئەم هەفتەیە"   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_weekValueName" runat="server" Text='<%# Eval("weekValueName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="بەروار بۆ"    >
                                              ...
                                              <asp:TemplateField HeaderText="چالاکی ڕێنماییکار بۆ ئەم بەهایە"    >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_guideActivity" runat="server" Text='<%# Eval("guideActivity") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="sds_WeekValueAndGuideProjectTasks" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3WeekValueAndGuideProjectTask_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3WeekValueAndGuideProjectTask_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3WeekValueAndGuideProjectTask_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3WeekValueAndGuideProjectTask_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_weekValueAndGuideProjectTask_ID" Name="weekValueAndGuideProjectTask_ID" Type="Int32" />
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="txt_weekValueName" Name="weekValueName" Type="String" />
                ...
                <asp:ControlParameter ControlID="txt_dateTo"  Name="dateTo" DbType="Date" />
                  ...
                  <asp:ControlParameter ControlID="txt_guideActivity" Name="guideActivity" Type="String" />
