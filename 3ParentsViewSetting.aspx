<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="ParentsViewSetting3" Codebehind="3ParentsViewSetting.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                      ...
                      <%--  ==========================================================================================================================--%>
                      <%--  ==========================================================================================================================--%>
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="هۆکاری بینینی دایباب"></asp:Label>
                      <%--  ==========================================================================================================================--%>
                    <%--    ==========================================================================================================================--%>
                     <%--   ==========================================================================================================================--%>
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="هۆکاری بینینی دایک و باوک" CssClass="lbl_style"></asp:Label>
</label>

          <asp:TextBox ID="txt_parentsReasonView" runat="server" class="form-control font1 b_textbox" autoComplete="off"  MaxLength="1000"></asp:TextBox>
    
                        <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="txt_parentsReasonView" runat="server" ID="RequiredFieldValidator3" 
                         ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="Status1" CssClass="lbl_style"></asp:Label>
      ...
      <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_Status1" runat="server"   
                                 ...
                                 Width="100%"  AppendDataBoundItems="true"   Filter="Contains">
                                    <Items>
                                         <telerik:RadComboBoxItem Value="1" Text="بەڵێ" />
                                        <telerik:RadComboBoxItem Value="0" Text="نەخێر" />
...
<script type="text/javascript">
            ...
            <%--  ==========================================================================================================================--%>
                   ...
                   <asp:Label ID="lbl_parentsViewSetting_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="parentsViewSetting_ID"
                                        DataSourceID="sds_parentsViewSettings" Width="100%" GridLines="None" PageSize="30">
         ...
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="Qualification_ID" InsertVisible="False" >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_parentsViewSetting_ID_GV" runat="server" Text='<%# Eval("parentsViewSetting_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:TemplateField HeaderText="هۆکاری بینینی دایک و باوک"    >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_parentsReasonView" runat="server" Text='<%# Eval("parentsReasonView") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
 ...
 --%>
    ...
    <asp:SqlDataSource ID="sds_parentsViewSettings" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="3ParentsViewSetting_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="3ParentsViewSetting_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="3ParentsViewSetting_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="3ParentsViewSetting_Update"
        UpdateCommandType="StoredProcedure">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_parentsViewSetting_ID" Name="parentsViewSetting_ID" Type="Int32" />
            ...
            <InsertParameters>
               ...
               <asp:ControlParameter ControlID="txt_parentsReasonView"  Name="parentsReasonView" Type="String" />
