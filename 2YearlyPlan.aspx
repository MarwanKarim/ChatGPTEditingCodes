<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageEducation.master" AutoEventWireup="true" Inherits="YearlyPlan2" Codebehind="2YearlyPlan.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="پلانی ساڵانە"></asp:Label>
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label8" runat="server" Text="تێبینی" CssClass="lbl_style"></asp:Label>
</label>
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_yearlyPlan_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="yearlyPlan_ID"
                                        DataSourceID="sds_yearlyPlans" Width="100%" GridLines="None" PageSize="30">
         ...
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText=" " InsertVisible="False" Visible="false" >
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_yearlyPlan_ID_GV" runat="server" Text='<%# Eval("yearlyPlan_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<%--                                                       <asp:TemplateField HeaderText="تێبینی"    >
 ...
 <asp:Label ID="lbl_date_insert" runat="server" Text='<%# Eval("date_insert") %>'></asp:Label>
    ...
    <asp:SqlDataSource ID="sds_yearlyPlans" runat="server"
            ConnectionString="<%$ ConnectionStrings:SchoolManagmentDB_ConnectionString %>" 



            SelectCommand="2yearlyPlan_Select"
        SelectCommandType="StoredProcedure"


        DeleteCommand="2yearlyPlan_Delete" 
        DeleteCommandType="StoredProcedure" 


        InsertCommand="2yearlyPlan_Insert"
                InsertCommandType="StoredProcedure" 


        UpdateCommand="2yearlyPlan_Update"
 ...
 <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />        
            ...
            <DeleteParameters>
                <asp:ControlParameter ControlID="lbl_yearlyPlan_ID" Name="yearlyPlan_ID" Type="Int32" />
