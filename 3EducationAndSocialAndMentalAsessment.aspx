            ...
            <div class="row">
                <div class="col-7 align-self-center">
                    <h6 class="page-title" style="width: 400px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="هەڵسەنگاندنی پەروەردەیی و کۆمەڵایەتی و دەروونی"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label6" runat="server" Text="ناوی قوتابی" CssClass="lbl_style"></asp:Label>
      ...
      <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_Student" runat="server"   
        ...
        DataTextField = "StudentNameK" EmptyMessage="هەڵبژێرە"
...
&nbsp;&nbsp;
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="جۆری هەڵسەنگاندن" CssClass="lbl_style"></asp:Label>
</label>
    ...
    <%--    DataTextField = "StaffName"
      ...
      <telerik:RadComboBox RenderMode="Lightweight" ID="ddl_typeOfAsessment" runat="server"   
                                 ...
                                 Width="100%"  AppendDataBoundItems="true"   Filter="Contains">
                                    <Items>
                                        <telerik:RadComboBoxItem Value="1" Text="‌هەڵسەنگاندنی پەروەردەیی" />
                                         <telerik:RadComboBoxItem Value="2" Text="هەڵسەنگاندنی دەروونی" />
                                          <telerik:RadComboBoxItem Value="3" Text="هەڵسەنگاندنی کۆمەڵایەتی" />
         ...
         <ItemTemplate>
                 <%# Container.DataItemIndex + 1 %>   
                                            ...
                                            <asp:TemplateField HeaderText="وەرزی هەڵسەنگاندن"   >
                                                ...
                                                <asp:TemplateField HeaderText="جۆری هەڵسەنگاندن"   >
