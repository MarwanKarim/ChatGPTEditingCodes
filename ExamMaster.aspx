<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Group_Top.master" AutoEventWireup="true" Inherits="ExamMaster" Codebehind="ExamMaster.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-5 align-self-center">
                    <h6 class="page-title" style="width: 350px!important">&nbsp;&nbsp;
                             <asp:Label ID="lbl_header_str" runat="server" CssClass="font_header1" Text="Exam Group"></asp:Label>
...
&nbsp;&nbsp;
  <asp:Label ID="Label2" runat="server" Text="   Exam Group |Kurdish " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_ExamName" runat="server" class="form-control font1 b_textbox" MaxLength="300" autocomplete="off"></asp:TextBox>
    


         <asp:RequiredFieldValidator ControlToValidate="txt_ExamName" runat="server" ID="RequiredFieldValidator2" 
 ...
 <label for="validationCustom02">
&nbsp;&nbsp;
  <asp:Label ID="Label1" runat="server" Text="   Exam Group | English " CssClass="lbl_style"></asp:Label>
</label>

            
 <asp:TextBox ID="txt_ExamNameE" runat="server" class="form-control font1 b_textbox" MaxLength="300" autocomplete="off"></asp:TextBox>
    


         <asp:RequiredFieldValidator ControlToValidate="txt_ExamNameE" runat="server" ID="RequiredFieldValidator1" 
                                    ValidationGroup="grpRegistration"    Text="Required" ForeColor="Red" CssClass="font1" />
...
<script type="text/javascript">
   ...
   <asp:Label ID="lbl_ExamMaster_ID" runat="server" Font-Bold="True" ForeColor="Black" Visible="False"></asp:Label>
   <asp:Label ID="lbl_result_msg" runat="server" Text="Date Added succesfully ." Visible="False"></asp:Label>
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive font1" style="overflow-x: scroll">
                                    ...
                                    <asp:GridView ID="Gridview1"
                                        ...
                                        CellPadding="0" CssClass=" " AllowPaging="True" DataKeyNames="ExamMaster_ID"
                                        DataSourceID="sds_ExamMaster" Width="100%" GridLines="None" PageSize="30">
                     ...
                     <asp:LinkButton ID="lnk_Edit" runat="server" OnClick="Lnk_Edit_Click" ToolTip="Edit" 
                                            ...
                                            <asp:TemplateField HeaderText="ExamMaster_ID" InsertVisible="False" SortExpression="CatNo" Visible="False">

                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_ExamMaster_ID_GV" runat="server" Text='<%# Eval("ExamMaster_ID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                                 <asp:TemplateField HeaderText="Exam | Kurdish "   >
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:TemplateField HeaderText="Exam | English "   >
                                              
                                                <ItemTemplate>
                                                    <asp:Label ID="LabelExamNameE" runat="server" Text='<%# Eval("ExamNameE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <!--    <script src="bootstrap/dist/js/custom.min.js"></script>-->
        ...
        SelectCommand="ExamMaster_Select" DeleteCommand="ExamMaster_Delete"
        DeleteCommandType="StoredProcedure" InsertCommand="ExamMaster_Insert"
        InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure"
        UpdateCommand="ExamMaster_Update" UpdateCommandType="StoredProcedure"
            
            OnInserted="sds_ExamMaster_Inserted"
            OnUpdated="sds_ExamMaster_Updated"
            OnDeleted="sds_ExamMaster_Deleted"
            
            >
        <DeleteParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
         <asp:ControlParameter ControlID="lbl_ExamMaster_ID" Name="ExamMaster_ID" Type="Int32" />
           <asp:ControlParameter ControlID="lbl_UserID" Name="user_Insert" Type="Int32" DefaultValue="0" />
        </DeleteParameters>
        <InsertParameters>
           <asp:Parameter Direction="InputOutput" Name="ErrorMessage" Type="String" DefaultValue="000" ConvertEmptyStringToNull="true" />
         <asp:ControlParameter ControlID="txt_ExamName" Name="ExamName" Type="String" />

                <asp:ControlParameter ControlID="txt_ExamNameE" Name="ExamNameE" Type="String" />
